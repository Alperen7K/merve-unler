  ...
  return (
    ...
    >
      <div>
        <img
          alt="icon"
          className="blur-sm h-[40vh] lg:h-[70vh] rounded-[10px] mt-4 border-solid border-4 border-black drop-shadow-[0_35px_35px_rgba(0,0,0,0.25)]"
          src={mustafa}
        />
      </div>
      <div>
        ...
        <div className="flex flex-col items-start justify-center">
          <a className={aClass} href="tel:+90 545 568 98 97">
            <img alt="icon" className={iconClass} src={phone} />
            <label className={labelClass}>+90 545 568 98 97</label>
          </a>
